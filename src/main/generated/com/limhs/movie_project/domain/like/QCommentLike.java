...
public class QCommentLike extends EntityPathBase<CommentLike> {
    ...
    private static final long serialVersionUID = 288973989L;
    ...
    public final com.limhs.movie_project.domain.comment.QComment comment;
    ...
    public QCommentLike(Class<? extends CommentLike> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new com.limhs.movie_project.domain.comment.QComment(forProperty("comment"), inits.get("comment")) : null;
